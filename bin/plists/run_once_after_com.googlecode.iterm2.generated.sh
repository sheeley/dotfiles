...
defaults write com.googlecode.iterm2 "ApplePressAndHoldEnabled" -boolean false
defaults write com.googlecode.iterm2 "AppleWindowTabbingMode" -string 'manual'
defaults write com.googlecode.iterm2 "Default Bookmark Guid" -string '60448888-CD36-4E77-B929-32DF8A7EF2C8'
defaults write com.googlecode.iterm2 "EnableProxyIcon" -boolean false
...
'
defaults write com.googlecode.iterm2 "HapticFeedbackForEsc" -boolean false
defaults write com.googlecode.iterm2 "IRMemory" -integer 4
defaults write com.googlecode.iterm2 "LeftCommand" -integer 7
defaults write com.googlecode.iterm2 "New Bookmarks" '
<array>
	<dict>
		...
		<key>Guid</key>
		<string>60448888-CD36-4E77-B929-32DF8A7EF2C8</string>
		...
		<true/>
		<key>Normal Font</key>
		<string>FiraCodeNerdFontCompleteM-Regular 12</string>
...
defaults write com.googlecode.iterm2 "PointerActions" '
<dict>
	<key>Button,1,1,,</key>
	<dict>
		<key>Action</key>
...
defaults write com.googlecode.iterm2 "SUAutomaticallyUpdate" -boolean true
defaults write com.googlecode.iterm2 "TabViewType" -integer 0
defaults write com.googlecode.iterm2 "UseBorder" -boolean false
defaults write com.googlecode.iterm2 "VisualIndicatorForEsc" -boolean false
defaults write com.googlecode.iterm2 "WindowNumber" -boolean false
defaults write com.googlecode.iterm2 "WordCharacters" -string '/-+\~_.'
defaults write com.googlecode.iterm2 "findMode_iTerm" -integer 0
defaults write com.googlecode.iterm2 "iTerm Version" -string '3.4.6'
